...
cat("✅ M4 education-stratified IPW coefficients exported to m4_coefs_edu_ipw.csv\n\n")
...
cat("✅ M7 gender-stratified IPW coefficients exported to m7_ipw_sex_ncs_int.csv\n\n")
